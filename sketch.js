...
//blower.mouseClicked(airBlow);
  ...
  bunny = createSprite(1000,930,100,100);
  bunny.scale = 0.2;
  bunny.visible=false;
...
button1=createSprite(900,980,100,100);
...
function oxygenBar() {
  push()
  image(oxygenimg, width / 2 - 130, height - bunny.positionY - 350, 20, 20);
  fill("white");
  rect(width / 2 - 100, height - bunny.positionY - 350, 185, 20);
  fill("#ffc400");
  rect(width / 2 - 100, height - bunny.positionY - 350, bunny.oxygen, 20);
  noStroke();
  pop()
}